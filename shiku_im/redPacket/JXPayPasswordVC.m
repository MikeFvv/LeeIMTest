...
- (void)setupViews {
    ...
    self.nextBtn.frame = CGRectMake(20, CGRectGetMaxY(self.textField.frame)+25, JX_SCREEN_WIDTH-40, 44);
...
//        [g_navigation popToViewController:[JXMoneyMenuViewController class] animated:YES];
        ...
        // 原逻辑无法pop, 修改pop逻辑
        [g_navigation popToViewController:[JXMyMoneyViewController class] animated:YES];

//        [g_navigation dismissViewController:self animated:true];
    }
