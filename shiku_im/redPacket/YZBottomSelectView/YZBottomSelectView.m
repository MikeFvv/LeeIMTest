...
static const CGFloat kRowHeight = 56.0f;
...
//                button.titleEdgeInsets = UIEdgeInsetsMake(0, 10, 0, -10);
                ...
                imageView.frame = CGRectMake(30, (kRowHeight - 30) / 2 - 3, 30, 30);
                [button addSubview:imageView];
                
                UILabel *titleLabel = [UILabel new];
                titleLabel.frame = CGRectMake(70, imageView.frame.origin.y, 200, 15);
                titleLabel.text = otherButtonTitles[i];
                titleLabel.font = [UIFont systemFontOfSize:14];
                titleLabel.textColor = [UIColor darkGrayColor];
                [button addSubview:titleLabel];
                
                UILabel *subTitleLabel = [UILabel new];
                subTitleLabel.frame = CGRectMake(70, CGRectGetMaxY(titleLabel.frame) + 2, 200, 18);
                subTitleLabel.text = subTitlesArray[i];
                ...
                if (rightTitleArray.count > 0) {
                    ...
                    rightLabel.frame = CGRectMake(180, 0, 200, kRowHeight);
                ...
                if (i == selectIndex) {
                    ...
                    UIImageView *selectImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ic_selected_done_2"]];
                    selectImageView.frame = CGRectMake(JX_SCREEN_WIDTH - 40, (kRowHeight - 20) / 2, 20, 20);
...
+ (void)showBottomSelectViewWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles subTitlesArray:(NSArray *)subTitlesArray rightTitleArray :(NSArray *)rightTitleArray                      imageIconArray:(NSArray *)imageAray                           selectIndex:(NSInteger)selectIndex
 handler:(YZBottomSelectViewBlock)bottomSelectViewBlock {
    
    YZBottomSelectView *bottomSelectView = [[self alloc] initWithTitle:title cancelButtonTitle:cancelButtonTitle destructiveButtonTitle:destructiveButtonTitle otherButtonTitles:otherButtonTitles subTitlesArray:subTitlesArray rightTitleArray: rightTitleArray imageIconArray:imageAray selectIndex:selectIndex handler:bottomSelectViewBlock];
