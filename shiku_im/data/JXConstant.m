...
-(NSString*)getCurCountryFieldName{
    ...
    }else if ([_sysLanguage isEqualToString:@"malay"]) { //马来
        
        name = [[NSString alloc] initWithFormat:@"%@",MALAYNAME];
    }else if ([_sysLanguage isEqualToString:@"th"]) { //泰语
        
        name = [[NSString alloc] initWithFormat:@"%@",THNAME];
    }else if ([_sysLanguage isEqualToString:@"jp"]) { //日语
        name = [[NSString alloc] initWithFormat:@"%@",JPNAME];
    }else if ([_sysLanguage isEqualToString:@"yinni"]) { //马来西亚语
        name = [[NSString alloc] initWithFormat:@"%@",YINNINAME];
    }else{
