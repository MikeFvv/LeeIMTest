...
-(void)createHeaderView{
    ...
    _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, JX_SCREEN_WIDTH, heightHeader)];
    
//    if (THESIMPLESTYLE) {
//        _imageView.image = [[UIImage imageNamed:@"navBarBackground"] imageWithTintColor:[UIColor whiteColor]];
//    }else {
//        _imageView.image = [g_theme themeTintImage:@"navBarBackground"];//[UIImage imageNamed:@"navBarBackground"];
//    }
    _imageView.userInteractionEnabled = YES;
    [tableHeader addSubview:_imageView];
//    [iv release];
...
//        [tableFooter release];
    ...
    tableBody.backgroundColor = [UIColor clearColor];
