...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(15, CellHeight - 0.5, JX_SCREEN_WIDTH - 15, 0.5)];
        line.backgroundColor = HEXCOLOR(0xf0f0f0);
        [cell.contentView addSubview:line];
        
        UIImageView *selectImage = [[UIImageView alloc] initWithFrame:CGRectMake(JX_SCREEN_WIDTH - 30, (CellHeight - 15) / 2, 15, 15)];
        selectImage.tag = 1000;
        selectImage.center = CGPointMake(selectImage.center.x, CellHeight / 2);
