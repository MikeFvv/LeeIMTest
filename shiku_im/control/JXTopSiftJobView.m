...
//            [leftVerticalLine release];
        ...
        for (int i=0; i<_dataArray.count; i++) {
            UIButton *itemBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.itemBtnWidth*i, 0, self.itemBtnWidth, self.height)];
            itemBtn.tag = i+100;
...
//            [itemBtn release];
        ...
        //底部滑动线条
        _bottomSlideLine = [[UIView alloc] initWithFrame:CGRectMake(0, self.height-2, self.itemBtnWidth, 2)];
...
- (void)itemBtnClick:(UIButton *)btn{
    _bottomSlideLine.left = btn.left;
