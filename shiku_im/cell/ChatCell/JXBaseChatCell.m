...
-(void)creatBaseUI{
    ...
    _headImage.layer.cornerRadius = 3.0f;// lewis HEAD_SIZE / 2;
...
//    [_headImage release];
    ...
    _cerImgView.contentMode = UIViewContentModeBottom;
    ...
    _timeLabel.textColor = HEXCOLOR(0xB5B5B5);
...
- (void)setBackgroundImage{
    ...
    if(self.msg.isMySend){
        ...
        _timeLabel.frame = CGRectMake(_bubbleBg.frame.origin.x - _readView.frame.size.width +5, _readView.frame.origin.y + 14, 40, 20);
    }else{
        ...
        _timeLabel.frame = CGRectMake(_readView.frame.origin.x-5, _readView.frame.origin.y + 14, 40, 20);
    }
