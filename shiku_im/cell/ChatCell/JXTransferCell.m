...
//    _imageBackground.image = [[UIImage imageNamed:@"hongbaokuan"] stretchableImageWithLeftCapWidth:10 topCapHeight:10];
    ...
    _headImageView.frame = CGRectMake(15,25, 50, 50);
    ...
    _nameLabel.frame = CGRectMake(CGRectGetMaxX(_headImageView.frame) + 10, CGRectGetMinY(_headImageView.frame), 180, 20);
    ...
    _title.text = [NSString stringWithFormat:@"    %@", [NSString stringWithFormat:@"%@转账",XL_APP_NAME]];
...
//        self.bubbleBg.frame = CGRectMake((JX_SCREEN_WIDTH-HEAD_SIZE - kChatCellMaxWidth - INSETS * 4 + CHAT_WIDTH_ICON) / 0.9 , INSETS, (kChatCellMaxWidth + INSETS * 2) * 0.9 , (n + INSETS - 4) * 0.9);
    ...
    self.bubbleBg.layer.cornerRadius = 10;
    self.bubbleBg.layer.masksToBounds = YES;
    
    _headImageView.frame = CGRectMake(15, (_imageBackground.frame.size.height - 22 - 45) / 2, 45, 45);
    _nameLabel.frame = CGRectMake(CGRectGetMaxX(_headImageView.frame) + 10, CGRectGetMinY(_headImageView.frame), 180, 20);
    _moneyLabel.frame = CGRectMake(CGRectGetMaxX(_headImageView.frame) + 10, CGRectGetMaxY(_headImageView.frame) - 20, 180, 20);
