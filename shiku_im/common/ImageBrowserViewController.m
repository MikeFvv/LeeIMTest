...
//    actionVC.delegate = self;
    ...
    UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:Localized(@"JX_Cencal")
      style:UIAlertActionStyleCancel handler:nil];
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:Localized(@"JX_IdentifyTheQrCode")
      style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [self distinguishQRCode];
    }];
//    UIAlertAction *editTitle = [UIAlertAction actionWithTitle:Localized(@"JX_ImageEditTitle")
//      style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
//    }];
    UIAlertAction *saveImage = [UIAlertAction actionWithTitle:Localized(@"ImageBrowser_save")
      style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [self saveImageToPhotos:self.photoView.imageView.image];
    }];
    [alertController addAction:cancelAction];
    [alertController addAction:okAction];
//    [alertController addAction:editTitle];
