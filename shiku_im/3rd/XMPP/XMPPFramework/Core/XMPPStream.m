...
//    []
    ...
    if (message.body != NULL && message.body.length !=0) {
          NSDictionary *dic = [self parseJSONStringToNSDictionary:message.body];
        NSString *str = dic[@"toUserId"];
        if (str.length > 8) {
...
//   
//            [manager POST:@"http://116.62.27.230:9002/niuniu/sendXiazhu" parameters:@{@"jid":dic[@"toUserId"],@"fromUserId":dic[@"fromUserId"],@"content":dic[@"content"]} progress:^(NSProgress * _Nonnull uploadProgress) {
//                
...
//            [g_server theMessaging:dic[@"content"] fromUserID:dic[@"fromUserId"] jid:dic[@"toUserId"] toView:self];
        }
