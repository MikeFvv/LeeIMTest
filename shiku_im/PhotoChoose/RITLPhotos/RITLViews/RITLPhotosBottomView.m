...
//                view.titleEdgeInsets = UIEdgeInsetsMake(0, -40, 0, 0);
//            }
            
            view.imageEdgeInsets = UIEdgeInsetsMake(5, 0, 5, 0);
            
            
            view.imageView.contentMode = UIViewContentModeScaleAspectFit;
            
            UIImage *image = [NSBundle.ritl_bottomUnselected imageByScalingToSize:CGSizeMake(30, 30)];
            UIImage *selectImage = [NSBundle.ritl_bottomSelected imageByScalingToSize:CGSizeMake(30, 30)];
...
//            [view setImage:/*@"RITLPhotos.bundle/ritl_bottomSelected".ritl_image*/NSBundle.ritl_bottomSelected forState:UIControlStateSelected];
            ...
            [view setImage:selectImage forState:UIControlStateSelected];
