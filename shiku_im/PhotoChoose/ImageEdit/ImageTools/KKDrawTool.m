...
+ (NSString*)defaultTitle{
    return Localized(@"JX_ImageEditDraw");
}
...
- (void)setup
{
    ...
    _menuView = [[UIView alloc] initWithFrame:CGRectMake(self.editor.menuView.frame.origin.x, self.editor.view.height - 80, self.editor.menuView.frame.size.width, 80)];
