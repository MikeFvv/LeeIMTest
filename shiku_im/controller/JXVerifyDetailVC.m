...
- (void)customView {
    ...
    _confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(view.frame) + 20, JX_SCREEN_WIDTH-40, 44)];
    ...
    _confirmBtn.layer.cornerRadius = _confirmBtn.height*0.5;
