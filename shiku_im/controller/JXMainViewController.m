...
//        _weiboVC = [_weiboVC init];
        ...
        _discoveryVC = [JXDiscoveryVC new];
        _discoveryVC.user = g_server.myself;
        _discoveryVC.homeVC = self;
        
        _findVC = [[FindViewController alloc] init];
//        _findVC.user = g_server.myself;
//        _findVC.homeVC = self;
        ...
        _ykdVC = [[YKDWebViewController alloc] init];
...
//    NSArray *roomArray = [[JXUserObject sharedInstance] fetchAllRoomsFromLocal];
...
//#endif
    ...
    if ([XL_Tabbar_Middle isEqualToString:@""]) {
        ...
        _tb.items = [NSArray arrayWithObjects:Localized(@"JXMainViewController_Message"),Localized(@"JX_MailList"),XL_Tabbar_Middle,Localized(@"JXMainViewController_Find"), Localized(@"JX_My"),nil];
        
        _tb.imagesNormal = [NSArray arrayWithObjects:@"news_normal",@"group_chat_normal",@"ykdicon",@"find_normal",@"me_normal",nil];
        _tb.imagesSelect = [NSArray arrayWithObjects:@"news_press_gray",@"group_chat_press_gray",@"ykdicon",@"find_press_gray",@"me_press_gray",nil];
    }
...
//                 [[JXXMPP sharedInstance].roomPool joinRoom:user.userId title:user.userNickname isNew:YES];
//                [[JXSynTask sharedInstance] getTaskWithUserId:user.userId];
//                [g_xmpp.chatingUserIds addObject:user.userId];
//                
...
//                msg.isGroup = YES;
//                msg.fromUserName = user.userNickname;
//            
//
//                msg.content      = @"";
//
...
//                [[JXXMPP sharedInstance]sendMessage:msg roomName:user.userId];
