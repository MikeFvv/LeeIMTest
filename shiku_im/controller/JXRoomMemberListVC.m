...
//    [g_window addSubview:_menu];
    ...
    if (XL_PermanentlyBanned == 1) {
        actionVC = [[JXActionSheetVC alloc] initWithImages:@[] names:@[Localized(@"JXAlert_NotGag"),Localized(@"JXAlert_GagTenMinute"),Localized(@"JXAlert_GagOneHour"),Localized(@"JXAlert_GagOne"),Localized(@"JXAlert_GagThere"),Localized(@"JXAlert_GagOneWeek"),Localized(@"JXAlert_GagFifteen"),@"永久禁言"]];
    }
...
- (void)actionSheet:(JXActionSheetVC *)actionSheet didButtonWithIndex:(NSInteger)index {
    ...
    switch (index) {
        ...
        case 6:
            ...
            break;
        case 7:
            member.talkTime = 3600*24*3600+n;
            break;
