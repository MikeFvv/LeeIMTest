...
- (void)customView {
    ...
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, JX_SCREEN_TOP, JX_SCREEN_WIDTH, 8)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.timeLabel.frame = CGRectMake(JX_SCREEN_WIDTH - 120-20, (56 - 20) / 2, 115, 20);
