...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        UIImageView* iv;
        iv = [[UIImageView alloc] initWithFrame:CGRectMake(JX_SCREEN_WIDTH-INSETS-20-3, (CellHeight - 20) / 2, 20, 20)];
        iv.image = [UIImage imageNamed:@"set_list_next"];
        [cell.contentView addSubview:iv];
        
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, CellHeight - 0.5, JX_SCREEN_WIDTH, 0.5)];
