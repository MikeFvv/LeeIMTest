...
@interface JXNearVC () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,JXActionSheetVCDelegate,UITableViewDelegate,UITableViewDataSource,BMKMapViewDelegate,BMKLocationServiceDelegate>
{
...
- (void)didUpdateBMKUserLocation:(BMKUserLocation *)userLocation
{
        ...
        self.locY = userLocation.location.coordinate.longitude;
        self.locX = userLocation.location.coordinate.latitude;
