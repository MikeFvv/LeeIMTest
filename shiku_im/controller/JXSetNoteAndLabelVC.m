...
- (void)customView {
    ...
    _name = [[UITextField alloc] initWithFrame:CGRectMake(0,CGRectGetMaxY(nameLab.frame)+INSETS,JX_SCREEN_WIDTH,56)];
    ...
    // 标签
    _labT = [[UILabel alloc] initWithFrame:CGRectMake(16, CGRectGetMaxY(_name.frame)+8, 40, 18)];
    _labT.text = Localized(@"JX_Label");
    _labT.textColor = [UIColor grayColor];
    _labT.font = SYSFONT(15);
    [self.tableBody addSubview:_labT];

    UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_labT.frame)+INSETS, JX_SCREEN_WIDTH, 56)];
    ...
    _labContLab = [[UILabel alloc] initWithFrame:CGRectMake(16, 0, JX_SCREEN_WIDTH-INSETS-41, 56)];
...
//    [_labContLab addGestureRecognizer:tap];
    ...
    _baseView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(deatilLab.frame)+INSETS, JX_SCREEN_WIDTH, 56)];
    ...
    _detail.frame = CGRectMake(16,10,JX_SCREEN_WIDTH-32,56);
