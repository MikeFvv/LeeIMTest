...
//    [allSelect setBackgroundImage:[UIImage createImageWithColor:[UIColor clearColor]] forState:UIControlStateSelected];
    ...
    //搜索输入框
    _tableHeadView = [[UIView alloc] initWithFrame:CGRectMake(0, JX_SCREEN_TOP, JX_SCREEN_WIDTH, 65)];
...
//    [backView addSubview:cancelBtn];
    ...
    _seekTextField = [[UITextField alloc] initWithFrame:CGRectMake(15, 10, _tableHeadView.frame.size.width - 30, 40)];
...
//    [_tableHeadView addSubview:lineView];
    ...
    UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(0, 50, JX_SCREEN_WIDTH, 56)];
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(btn.frame) - 0.5, JX_SCREEN_WIDTH, 0.5)];
    lineView.backgroundColor = HEXCOLOR(0xdcdcdc);
    [_tableHeadView addSubview:lineView];
