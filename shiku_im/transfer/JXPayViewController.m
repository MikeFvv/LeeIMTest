...
- (void)setupNav {
    ...
    [btn setBackgroundImage:[UIImage imageNamed:@"title_back_white"] forState:UIControlStateNormal];
...
- (void)setupViews {
    ...
    iv.frame = CGRectMake(10, CGRectGetMaxY(baseView.frame)+20, JX_SCREEN_WIDTH-20, HEIGHT);
