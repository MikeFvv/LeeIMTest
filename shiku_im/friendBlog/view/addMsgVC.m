...
@interface addMsgVC()<VisibelDelegate,RITLPhotosViewControllerDelegate,JXSelectorVCDelegate, JXActionSheetVCDelegate, JXCameraVCDelegate,UITextViewDelegate>
...
-(void)setDataType:(int)value{
    ...
    self.canSeeBtn.frame = CGRectMake(0, _buildHeight, JX_SCREEN_WIDTH, 56);
    maxY = CGRectGetMaxY(self.canSeeBtn.frame);
    
    UIView * line = [[UIView alloc] init];
    line.frame = CGRectMake(15, CGRectGetMinY(self.canSeeBtn.frame), JX_SCREEN_WIDTH-15*2, 0.8);
...
//    }
    ...
    line1.frame = CGRectMake(15, CGRectGetMaxY(self.replybanBtn.frame), JX_SCREEN_WIDTH-15*2, 0.8);
    line1.backgroundColor = [UIColor colorWithWhite:0.9 alpha:0.5];
    [self.tableBody addSubview:line1];
    ...
    btn.frame = CGRectMake(20, h+maxY+30, JX_SCREEN_WIDTH-40, 44);
...
- (UIButton *)lableBtn {
    if (!_lableBtn) {
        ...
        _lableLabel.frame = CGRectMake(arrowView.frame.origin.x - 200 - 10, (56 - 30) / 2, 200, 30);
...
//        [_locBtn addSubview:_locLabel];
        ...
        UIImageView * arrowView = [[UIImageView alloc] initWithFrame:CGRectMake(JX_SCREEN_WIDTH-INSETS-20-3, (56 - 20) / 2, 20, 20)];
        arrowView.image = [UIImage imageNamed:@"set_list_next"];
...
//        [_canSeeBtn setTitle:Localized(@"JXBlog_whocansee") forState:UIControlStateSelected];
        ...
        UIImageView * arrowView = [[UIImageView alloc] initWithFrame:CGRectMake(JX_SCREEN_WIDTH-10-20-3, (56 - 20) / 2, 20, 20)];
        arrowView.image = [UIImage imageNamed:@"set_list_next"];
        ...
        _visibleLabel.frame = CGRectMake(CGRectGetMaxX(_canSeeBtn.titleLabel.frame)+_canSeeBtn.titleEdgeInsets.left+10, (56 - 30) / 2, CGRectGetMinX(arrowView.frame)-CGRectGetMaxX(_canSeeBtn.titleLabel.frame)-_canSeeBtn.titleEdgeInsets.left-10-10, 30);
...
-(UIButton *)remindWhoBtn{
    if (!_remindWhoBtn) {
        ...
        _remindLabel.frame = CGRectMake(CGRectGetMaxX(_remindWhoBtn.titleLabel.frame)+_remindWhoBtn.titleEdgeInsets.left+30, (56 - 30) / 2, CGRectGetMinX(arrowView.frame)-CGRectGetMaxX(_remindWhoBtn.titleLabel.frame)-_remindWhoBtn.titleEdgeInsets.left-10-30, 30);
...
- (UIButton *)replybanBtn {
    ...
    if (!_replybanBtn) {
        ...
        _checkbox.frame = CGRectMake(25, (56 - 20) / 2, 20, 20);
        [_replybanBtn addSubview:_checkbox];
        
        UILabel *tint = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_checkbox.frame)+13, (56 - 20) /2,200, 20)];
//        tint.text = Localized(@"JX_DoNotCommentOnThem");
        tint.text = @"所有人不可评论";
        tint.font = SYSFONT(16);
        [_replybanBtn addSubview:tint];
        
        UILabel *tintGray = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(tint.frame)+5, (56 - 20) /2, 120, 20)];
...
//    UIButton* btn = [self createButton:[NSString stringWithFormat:@"%@%@",Localized(@"JX_Add"),Localized(@"JX_Image")] icon:@"add_picture" action:@selector(actionImage:) parent:svImages];
    UIButton* btn = [self createButton:[NSString stringWithFormat:@"%@%@",Localized(@"JX_Add"),Localized(@"JX_Image")] icon:@"tianjiatupian" action:@selector(actionImage:) parent:svImages];
...
//        UIButton* btn = [self createButton:[NSString stringWithFormat:@"%@%@",Localized(@"JX_Add"),Localized(@"addMsgVC_AVoice")] icon:@"add_voice" action:@selector(onAddAudio) parent:svAudios];
        UIButton* btn = [self createButton:[NSString stringWithFormat:@"%@%@",Localized(@"JX_Add"),Localized(@"addMsgVC_AVoice")] icon:@"tianjiayuyin" action:@selector(onAddAudio) parent:svAudios];
...
//        UIButton* btn = [self createButton:[NSString stringWithFormat:@"%@%@",Localized(@"JX_Add"),Localized(@"JX_Video1")] icon:@"add_video" action:@selector(onAddVideo) parent:svVideos];
        UIButton* btn = [self createButton:[NSString stringWithFormat:@"%@%@",Localized(@"JX_Add"),Localized(@"JX_Video1")] icon:@"tianjiaship" action:@selector(onAddVideo) parent:svVideos];
        btn.frame = CGRectMake(10, 10, 60, 60);
    }
}
