...
//            g_App.isShowRedPacket = [NSString stringWithFormat:@"1"];
    ...
    if ([p objectForKey:@"isOpenSMSCode"]) {
        ...
        if (XL_Show_MsgCode == 1) {
            self.isOpenSMSCode = @"1";
        }
    }
...
//    }else {
//        self.apiUrl = @"http://43.228.66.144:8092/";
        //接口前缀URL,一般改这句即可，其他配置从服务器读取，在服务器改    蒲公英打包
//        com.rongli.zhiliao.share
        // lewis
//    self.apiUrl = @"http://imapi.suliao6688.com/";//畅聊
//    self.apiUrl = @"http://39.97.226.193:9002/"; // 畅聊
//self.apiUrl = @"http://103.121.93.146:9002/"; // 乡聊
//    self.apiUrl = @"http://121.196.120.152:9002/";
//    self.apiUrl = @"http://27.124.41.154:9002/"; // 众点传媒
//    self.apiUrl = @"http://111.231.173.98:9002/"; // 缅聊
//    self.apiUrl = @"http://202.95.8.73:9002/"; // 乐聊
//    self.apiUrl = @"http://47.115.11.93:9002/"; // 神洲集团
//        self.apiUrl = @"http:/119.45.144.95:9002/"; // 枝聊
//        self.apiUrl = @"http://139.196.197.36:9002/"; // 玖博国际
//        self.apiUrl = @"http://150.109.126.68:8092/"; // Vk极速版
//    self.apiUrl = @"http://45.10.235.254:9002/"; // 听股轩
//    self.apiUrl = @"http://121.201.102.130:9002/"; // 星聊
//    self.apiUrl = @"http://101.36.164.150:9002/"; // 圈圈
    
    self.apiUrl = XL_API_URL;
