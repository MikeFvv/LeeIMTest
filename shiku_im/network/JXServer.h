...
#define act_PayPwdReset @"user/payPassword/reset" //忘记支付密码
...
#define act_SendSMS @"basic/randcode/sendSms" //发送短信(未登录)
#define act_SendLoginSMS @"basic/randcode/logined/sendSms" //发送短信(登录)
#define act_Config @"config"
#define act_LoginConfig @"logined/config"//用于申请苹果
...
#define act_roomJoin @"room/join"  //加入群
...
#define act_sendRedPacketV2 @"redPacket/sendRedPacket/v2"//发红包(新)
...
#define act_BindBankCard    @"credit/bindCard"      //绑定银行卡

#define act_GetBankCardList    @"credit/bindCardList"      //绑定绑定银行卡列表

#define act_WithDraw        @"credit/applyDrawings"      //提现

#define act_DeleteBindBankCard    @"credit/unbindCard"      //删卡

#define act_GetThirdPayAddress    @"vendor/pay/launch"      //获取绑定卡

#define act_GetDiscoveryWebList    @"general/friendsterWebsiteList"      //获取朋友圈Web列表
#define act_GetNiuniuSendXiazhu    @"niuniu/sendXiazhu" // 记录消息
//niuniu/sendXiazhu
#define setUpdateFourElements    @"user/updateFourElements" // 设置实名状态
#define getUpdateFourElements    @"user/get" // 获取实名状态

#pragma mark - 声网
#define act_GetAgoraInfo @"general/agora/info" //获取用户信息
...
- (void)theMessaging:(NSString *)content fromUserID:(NSString *)fromUserId jid:(NSString *)jid toView:(id)toView;  //传消息
