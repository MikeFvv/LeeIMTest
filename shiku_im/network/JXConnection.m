...
-(AFHTTPSessionManager *)sharedHttpSessionManager {
    ...
    dispatch_once(&onceToken, ^{
        ...
        afManager.requestSerializer.timeoutInterval = 120.0;
    });
...
- (id) init {
    if (self = [super init]) {
        ...
        self.url = @"http://116.62.27.230:9002/";
...
//    long time = [self getNowTimestamp];
...
//    NSLog(@"设备当前的时间戳111:%ld",(long)time);
//
