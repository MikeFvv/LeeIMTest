...
@interface AppDelegate : UIResponder <UIApplicationDelegate,PKPushRegistryDelegate,JPUSHRegisterDelegate>{
}
...
@property (strong, nonatomic) NSString * isShowGroupRedPacket;
