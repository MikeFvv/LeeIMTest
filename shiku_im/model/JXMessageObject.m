...
-(void)fromDictionary:(NSMutableDictionary*)p
{
    ...
    NSLog(@"%f",[[p objectForKey:kMESSAGE_TIMESEND] doubleValue]);
...
//        if (XL_Hidden_System_Message == 1 && ([room length]>0 || self.isGroup) && [self.type intValue] == kWCMessageTypeRemind && isHiddenMsg(self.content)) {
//            return NO;
//        }
...
//        if (XL_Hidden_System_Message == 1 && p.isGroup && [p.type intValue] == kWCMessageTypeRemind && isHiddenMsg(p.content)) {
//
//        }else{
//
//        }
